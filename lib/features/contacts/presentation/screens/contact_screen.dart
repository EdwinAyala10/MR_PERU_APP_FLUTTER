...
import '../../../shared/infrastructure/formatters/phone_number_input_formatter.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: Text(
                '${contactState.contact!.id == 'new' ? 'Crear' : 'Editar'} contacto',
          ...
          floatingActionButton: contactState.contact != null
              ? FloatingActionButtonCustom(
                  ...
                  callOnPressed: () {
                    ...
                    ref
                        .read(
                            contactFormProvider(contactState.contact!).notifier)
                        .onFormSubmit()
                      ...
                      if (value.message != '') {
                        ...
                        if (value.response) {
                          ...
                          if (ref.read(isFromOpportunity)) {
                            ...
                            ref
                                .read(contactProvider(contactId).notifier)
...
class __ContactInformationv2State extends ConsumerState<_ContactInformationv2> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.contact.id == "new" && idEmpresa != "") {
        ref
            ...
            .onRucChanged(idEmpresa ?? '');
        ref
            .read(contactFormProvider(widget.contact).notifier)
            .onRazonChanged(nameEmpresa ?? '');
      }
    });
  }
                ...
                GestureDetector(
                  onTap: () {
                    _openSearch(context, ref,
                        contactForm.contactoUsuarioRegistro ?? '');
                  },
                  child: Container(
  ...
  void _openSearchCompanyLocales(
    ...
    showSearch<CompanyLocal?>(
      ...
      ref.read(contactFormProvider(widget.contact).notifier).onLocalChanged(
          companyLocal.id,
