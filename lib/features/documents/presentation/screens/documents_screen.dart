...
class DocumentsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: documentsState.isLoading 
        ? const FullScreenLoader() 
        : (documentsState.documents != null ?
         const _DocumentsView() : Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const Text('No se encontraron documentos'),
              const SizedBox(
                height: 10,
              ),
              ElevatedButton(
...
class _DocumentsViewState extends ConsumerState {
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () async {
                ...
                String tipoRegistro = document.adjtTipoRegistro;
