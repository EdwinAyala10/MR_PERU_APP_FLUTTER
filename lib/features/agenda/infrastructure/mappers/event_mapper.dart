...
class EventMapper {
  static jsonToEntity(Map<dynamic, dynamic> json) => Event(
        ...
        arraycontactoElimimar:
            json["EVENTOS_INVITACION_CONTACTO_ELIMINAR"] != null
                ? List<ContactArray>.from(
                    json["EVENTOS_INVITACION_CONTACTO_ELIMINAR"]
                        .map((x) => ContactArray.fromJson(x)))
                : [],
        ...
        arrayresponsableElimimar:
            json["EVENTOS_INVITACION_RESPONSABLE_ELIMINAR"] != null
                ? List<ResponsableArray>.from(
                    json["EVENTOS_INVITACION_RESPONSABLE_ELIMINAR"]
                        .map((x) => ResponsableArray.fromJson(x)))
                : [],
        ...
        evntNombreUsuarioResponsable:
            json['EVNT_NOMBRE_USUARIO_RESPONSABLE'] ?? '',
